...
class OpenAIService:
    ...
    async def analyze_text(self, text: str) -> CompetitorAnalysis:
        ...
        Формат ответа (строго JSON):
        {
            ...
            "target_audience": ["целевая аудитория 1", "целевая аудитория 2", ...],
            "marketing_tone": ["характеристика tone of voice 1", "характеристика tone of voice 2", ...],
        ...
        - Анализируй маркетинговый стиль, позиционирование и подачу текста"""
    ...
    async def analyze_image(self, image_base64: str, mime_type: str = "image/jpeg") -> ImageAnalysis:
        ...
        Формат ответа (строго JSON):
        {
            ...
            "target_emotion": ["эмоция 1", "эмоция 2", ...],
            "conversion_potential": ["фактор конверсии 1", "фактор конверсии 2", ...],
            "recommendations": ["рекомендация 1", "рекомендация 2", ...]
        }
        ...
        - Анализируй визуальную привлекательность и маркетинговую эффективность дизайна"""
    ...
    async def analyze_website_screenshot(
        ...
        Формат ответа (строго JSON):
        {
            ...
            "recommendations": ["рекомендация 1", "рекомендация 2", ...],
            "conversion_analysis": ["фактор конверсии 1", "фактор конверсии 2", ...],
            "brand_positioning": ["характеристика позиционирования 1", "характеристика позиционирования 2", ...],
        ...
        - Конверсионные элементы интерфейса
        - Позиционирование бренда и визуальную идентичность
